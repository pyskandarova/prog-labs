...
int main() {
    ...
    while (a!=9){
        switch (a){
            case 1 :
                list -> AddLast(list, "Chuuya", b, 3.5);
                cin >> a;
            case 2 :
                list -> AddLast(list, "Dazai", b, 3.5);
                cin >> a;
            case 3 :
                list -> AddLast(list, "Mori", b, 3.0);
                cin >> a;
            case 4 :
                list -> AddLast(list, "Koyo", b, 3.0);
                cin >> a;
            case 5 :
                list -> AddLast(list, "Yosano", b, 3.0);
                cin >> a;
            case 6 :
                list -> AddLast(list, "Ranpo", b, 3.0);
                cin >> a;
            case 7 :
                list -> AddLast(list, "Atsushi", b, 3.5);
                cin >> a;
            case 8 :
                list -> AddLast(list, "Gogol", b, 3.5);
                cin >> a;
            }
            b=b+1;
    }
